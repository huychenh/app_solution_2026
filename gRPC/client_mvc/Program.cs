...
// Register the gRPC Client for Category
// Remember to change the URL to match your ShopOnline.Api running port
builder.Services.AddGrpcClient<ShopOnline.Api.CategoryGrpc.CategoryGrpcClient>(o =>
{
    o.Address = new Uri(builder.Configuration["BaseURLSettings:ShopOnline_Api_Url"]);
});
