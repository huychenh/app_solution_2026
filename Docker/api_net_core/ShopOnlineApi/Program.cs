...
var internalIdentityUrl = builder.Configuration["BaseURLSettings:Internal_IdentityServer_Url"] ?? identityUrl;
...
using (var scope = app.Services.CreateScope())
{
    ...
    catch (Exception ex)
    {
        ...
        logger.LogError(ex, "An error occurred while applying automatic database migrations.");
    }
}
// -----------------------------------------------
